...
export const translations = {
  en: {
    ...
    insurance: {
      ...
      description: 'You can add and view your policies here. This data is stored securely and is only visible to you.',
      addPolicy: 'Add New Policy',
      viewPolicies: 'My Policies',
      formTitle: 'Add a New Insurance Policy',
      addSuccessToastTitle: 'Policy Added',
      addSuccessToastDescription: 'Your new insurance policy has been saved.',
      noPolicies: 'You haven\'t added any insurance policies yet.',
      addButton: 'Add Policy',
      cancelButton: 'Cancel',
      form: {
        policyName: 'Policy Name',
        policyNamePlaceholder: 'e.g. Health Advantage Plan',
        policyNumber: 'Policy Number / Agreement ID',
        policyNumberPlaceholder: 'Enter unique policy number',
        provider: 'Insurance Provider',
        providerPlaceholder: 'e.g. Life Insurance Corporation (LIC)',
        policyType: 'Policy Type',
        policyTypePlaceholder: 'Select a type',
        types: {
            life: 'Life Insurance',
            health: 'Health Insurance',
            jivanBima: 'Jivan Bima Scheme',
            other: 'Other'
        },
        issueDate: 'Issue Date',
        maturityDate: 'Maturity Date',
        datePlaceholder: 'Pick a date',
        premiumAmount: 'Premium Amount (INR)',
        nomineeName: 'Nominee Name',
        nomineeNamePlaceholder: 'Full name of the nominee',
        nomineeRelationship: 'Relationship with Nominee',
        nomineeRelationshipPlaceholder: 'e.g. Spouse, Son, Daughter',
      }
    }
  },
  hi: {
    ...
    insurance: {
      ...
      description: 'आप यहां अपनी पॉलिसियां जोड़ और देख सकते हैं। यह डेटा सुरक्षित रूप से संग्रहीत है और केवल आपको दिखाई देता है।',
      addPolicy: 'नई पॉलिसी जोड़ें',
      viewPolicies: 'मेरी पॉलिसियां',
      formTitle: 'एक नई बीमा पॉलिसी जोड़ें',
      addSuccessToastTitle: 'पॉलिसी जोड़ी गई',
      addSuccessToastDescription: 'आपकी नई बीमा पॉलिसी सहेज ली गई है।',
      noPolicies: 'आपने अभी तक कोई बीमा पॉलिसी नहीं जोड़ी है।',
      addButton: 'पॉलिसी जोड़ें',
      cancelButton: 'रद्द करें',
      form: {
        policyName: 'पॉलिसी का नाम',
        policyNamePlaceholder: 'उदा. स्वास्थ्य लाभ योजना',
        policyNumber: 'पॉलिसी नंबर / समझौता आईडी',
        policyNumberPlaceholder: 'अद्वितीय पॉलिसी नंबर दर्ज करें',
        provider: 'बीमा प्रदाता',
        providerPlaceholder: 'उदा. भारतीय जीवन बीमा निगम (LIC)',
        policyType: 'पॉलिसी का प्रकार',
        policyTypePlaceholder: 'एक प्रकार चुनें',
        types: {
            life: 'जीवन बीमा',
            health: 'स्वास्थ्य बीमा',
            jivanBima: 'जीवन बीमा योजना',
            other: 'अन्य'
        },
        issueDate: 'जारी करने की तारीख',
        maturityDate: 'परिपक्वता तिथि',
        datePlaceholder: 'एक तारीख चुनें',
        premiumAmount: 'प्रीमियम राशि (INR)',
        nomineeName: 'नामांकित व्यक्ति का नाम',
        nomineeNamePlaceholder: 'नामांकित व्यक्ति का पूरा नाम',
        nomineeRelationship: 'नामांकित व्यक्ति के साथ संबंध',
        nomineeRelationshipPlaceholder: 'उदा. पति/पत्नी, बेटा, बेटी',
      }
    }
  },
  mr: {
    ...
    insurance: {
      ...
      description: 'तुम्ही तुमच्या पॉलिसी येथे जोडू आणि पाहू शकता. हा डेटा सुरक्षितपणे संग्रहित केला जातो आणि फक्त तुम्हाला दिसतो.',
      addPolicy: 'नवीन पॉलिसी जोडा',
      viewPolicies: 'माझ्या पॉलिसी',
      formTitle: 'एक नवीन विमा पॉलिसी जोडा',
      addSuccessToastTitle: 'पॉलिसी जोडली',
      addSuccessToastDescription: 'तुमची नवीन विमा पॉलिसी सेव्ह झाली आहे.',
      noPolicies: 'तुम्ही अद्याप कोणतीही विमा पॉलिसी जोडलेली नाही.',
      addButton: 'पॉलिसी जोडा',
      cancelButton: 'रद्द करा',
      form: {
        policyName: 'पॉलिसीचे नाव',
        policyNamePlaceholder: 'उदा. हेल्थ ॲडव्हांटेज प्लॅन',
        policyNumber: 'पॉलिसी क्रमांक / करार आयडी',
        policyNumberPlaceholder: 'अद्वितीय पॉलिसी क्रमांक प्रविष्ट करा',
        provider: 'विमा प्रदाता',
        providerPlaceholder: 'उदा. भारतीय आयुर्विमा महामंडळ (LIC)',
        policyType: 'पॉलिसीचा प्रकार',
        policyTypePlaceholder: 'एक प्रकार निवडा',
        types: {
            life: 'जीवन विमा',
            health: 'आरोग्य विमा',
            jivanBima: 'जीवन विमा योजना',
            other: 'इतर'
        },
        issueDate: 'जारी करण्याची तारीख',
        maturityDate: 'मुदतपूर्तीची तारीख',
        datePlaceholder: 'एक तारीख निवडा',
        premiumAmount: 'प्रीमियम रक्कम (INR)',
        nomineeName: 'नामनिर्देशित व्यक्तीचे नाव',
        nomineeNamePlaceholder: 'नामनिर्देशित व्यक्तीचे पूर्ण नाव',
        nomineeRelationship: 'नामनिर्देशित व्यक्तीशी संबंध',
        nomineeRelationshipPlaceholder: 'उदा. पती/पत्नी, मुलगा, मुलगी',
      }
    }
  },
};
